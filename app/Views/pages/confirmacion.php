            ...
            <td class="header container">
                ...
                <div class="content">
                    <table bgcolor="#999999">
                        <tr>
                            <!-- <td><img src="img/ecom2.jpg" /></td> -->
                            <td align="center">
                                <h6 class="collapse">Soluciones IM</h6>
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <p>Creamos estrategias de marketing en buscadores y redes sociales
                                        que te ayudan generar nuevas oportunidades de venta,
                                        sitios web que posicionan a tu marca en los primeros lugares en buscadores y
                            ...
                            <tr>
                                <td>
                                    ...
                                    <ul class="sidebar">
                                        ...
                                        <li><a class=""><b>Datos PayU</b></a></li>
                                        <li><a class="">Refence Code: <?= $referenceCode ?></a></li>
                                        <li><a class="">Metodo: <?= $metodo ?></a></li>
                                        <li><a class="">Estado: <?= $estadoTx ?></a></li>
                                        <li><a class="">Descripción: <?= $extra1 ?></a></li>
                                        <li><a class="">Firma digital: <?= $firma ?></a></li>
                                        <li><a class="">Transación Id: <?= $transactionId ?></a></li>
                                        <li><a class="">Email: <?= $email ?></a></li>
                                        <li><a class="">Fecha: <?= $fecha ?></a></li>
                                        <li><a class="">Total: <?= $TX_VALUE ?>&nbsp<?= $moneda ?></a></li>
