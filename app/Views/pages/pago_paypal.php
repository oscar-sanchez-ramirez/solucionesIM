<?= $this->extend('templates/pasarelas') ?>
    ...
    <div class="wrap-contact100 som-tabla">
        <div class="contact100-form validate-form">
            ...
            <div class="container">
                ...
                <button type="button" class="btn btn-primary btn-lg btn-block border sombra" data-toggle="modal" data-target="#exampleModalCenter">
