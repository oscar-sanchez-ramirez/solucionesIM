                            ...
                            <tr>
                                <td>
                                    ...
                                    <ul class="sidebar">
                                        ...
                                        <li><a class=""><b>Datos Stripe</b></a></li>
                                        <li><a class="">ID: <?= $id ?></a></li>
                                        <li><a class="">Estatus: <?= $status ?></a></li>
                                        <li><a class="">Descripción: <?= $descripcion ?></a></li>
                                        <li><a class="">Tarjeta: <?= $cardNumero ?> <?= $cardTipo ?></a></li>
                                        <li><a class="">Total: <?= $monto ?>&nbsp<?= $moneda ?></a></li>
