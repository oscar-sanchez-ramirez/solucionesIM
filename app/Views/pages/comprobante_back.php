    ...
    <div class="container col-md-4">
        <div class="list-group">
            <button type="button" class="list-group-item list-group-item-action active text-center">
                Comprobante:<?= $comprobante['id_comprobantes'] ?>
            </button>
            ...
            <button type="button" class="list-group-item list-group-item-action">Total+IVA: $ <?= number_format($comprobante['comprobantes_total'], 2) ?></button>
